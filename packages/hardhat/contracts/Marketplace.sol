...
contract Marketplace {
    ...
    // Function to gift a product
    function giftProduct(uint256 _index, address recipient) public {
        require(msg.sender == products[_index].owner, "Only the owner can gift a product");
        products[_index].owner = payable(recipient);
    }
}